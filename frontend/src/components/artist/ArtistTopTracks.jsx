...
export default function ArtistTopTracks({ accessToken, id }) {
  ...
  useEffect(() => {
    ...
    axios
      .get(`${API_URL}/artists/${id}/top-tracks?market=US`, {
    ...
    <>
      <div className="mb-2 flex h-8 flex-row items-center justify-between px-8">
        <div className="flex items-center">
          ...
          <h5 className="pl-2 text-lg">Top Tracks</h5>
        </div>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
      ...
      {topTracks.length !== 0 ? (
        <ul className="mb-4 grid w-full grid-cols-1">
